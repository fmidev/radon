...
--
-- Name: grid_meps_ssv; Type: VIEW; Schema: public; Owner: radon_admin
--

CREATE VIEW public.grid_meps_ssv AS
...
ALTER TABLE public.grid_meps_ssv OWNER TO radon_admin;

--
-- Name: TABLE grid_meps_ssv; Type: ACL; Schema: public; Owner: radon_admin
--

GRANT SELECT ON TABLE public.grid_meps_ssv TO radon_ro;
