...
CREATE TABLE public.geom_rotated_latitude_longitude (
    ...
    datum_id integer,
    CONSTRAINT geom_rotated_latitude_longitude_datum_chk CHECK (((datum_id IS NULL) OR ((datum_id IS NOT NULL) AND (earth_shape_id IS NULL)))),
...
--
-- Name: geom_rotated_latitude_longitude geom_rotated_latitude_longitude_datum_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: radon_admin
--

ALTER TABLE ONLY public.geom_rotated_latitude_longitude
    ADD CONSTRAINT geom_rotated_latitude_longitude_datum_id_fkey FOREIGN KEY (datum_id) REFERENCES public.datum(id);
