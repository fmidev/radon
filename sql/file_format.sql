...
CREATE TRIGGER audit_trigger_row AFTER UPDATE ON public.file_format FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER file_format_last_updated_trg BEFORE UPDATE ON public.file_format FOR EACH ROW EXECUTE FUNCTION public.store_last_updated_f();
