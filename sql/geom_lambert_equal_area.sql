...
CREATE TRIGGER audit_trigger_row AFTER UPDATE ON public.geom_lambert_equal_area FOR EACH ROW EXECUTE PROCEDURE audit.if_modified_func('true');
...
CREATE TRIGGER geom_lambert_equal_area_store_last_updated_trg AFTER UPDATE ON public.geom_lambert_equal_area FOR EACH ROW EXECUTE PROCEDURE public.store_last_updated_f();
