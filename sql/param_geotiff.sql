...
CREATE TRIGGER audit_trigger_row AFTER UPDATE ON public.param_geotiff FOR EACH ROW EXECUTE PROCEDURE audit.if_modified_func('true');
...
CREATE TRIGGER param_geotiff_store_last_updated_trg BEFORE UPDATE ON public.param_geotiff FOR EACH ROW EXECUTE PROCEDURE public.store_last_updated_f();
